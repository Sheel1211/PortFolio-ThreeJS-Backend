...
//getUser is called every time when site is refreshed so we don't want that our email id and password are also fetched so we will use select in it.
...
//myProfile displays all details as it will be visible to only one who has logged in so we used findbyid();
